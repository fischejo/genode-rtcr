...
class Init_rtcr::Abandonable : Interface
{
	private:
...
class Init_rtcr::Parent_service : public Genode::Parent_service, public Abandonable
{
	private:
...
/**
 * Init_rtcr-specific representation of a child service
 */
class Init_rtcr::Routed_service : public Async_service, public Abandonable
{
	public:
