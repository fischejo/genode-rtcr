...
/***************************
 ** Init_rtcr::Server::Service **
 ***************************/

struct Init_rtcr::Server::Service
{
...
Init_rtcr::Server::Route
Init_rtcr::Server::Service::resolve_session_request(Session_label const &label)
{
	try {
...
Init_rtcr::Server::Route
Init_rtcr::Server::_resolve_session_request(Service::Name const &service_name,
...
void Init_rtcr::Server::session_ready(Session_state &session)
{
...
void Init_rtcr::Server::_close_session(Session_state &session,
...
void Init_rtcr::Server::session_closed(Session_state &session)
{
	_close_session(session, Parent::SESSION_CLOSED);
}


void Init_rtcr::Server::_handle_create_session_request(Xml_node request,
                                                  Parent::Client::Id id)
{
	/*
...
void Init_rtcr::Server::_handle_upgrade_session_request(Xml_node request,
                                                   Parent::Client::Id id)
{
...
void Init_rtcr::Server::_handle_close_session_request(Xml_node, Parent::Client::Id id)
{
	_client_id_space.apply<Session_state>(id, [&] (Session_state &session) {
...
void Init_rtcr::Server::_handle_session_request(Xml_node request)
{
...
void Init_rtcr::Server::_handle_session_requests()
{
...
void Init_rtcr::Server::apply_config(Xml_node config)
{
