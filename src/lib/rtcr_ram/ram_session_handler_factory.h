...
#ifndef _RTCR_RAM_SESSION_HANDLER_FACTORY_H_
#define _RTCR_RAM_SESSION_HANDLER_FACTORY_H_
...
/* Local includes */
#include "ram_session_handler.h"

using namespace Rtcr;

// factory for creating a Cpu_session_handler
class Ram_session_handler_factory : public Session_handler_factory
{
public:
