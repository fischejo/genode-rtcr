...
#include <rtcr_pd/stored_native_capability_info.h>
#include <rtcr_pd/stored_region_map_info.h>
#include <rtcr_pd/stored_signal_context_info.h>
#include <rtcr_pd/stored_signal_source_info.h>
